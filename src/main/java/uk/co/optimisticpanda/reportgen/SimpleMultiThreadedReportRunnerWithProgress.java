...
public class SimpleMultiThreadedReportRunnerWithProgress {

    private static final Logger L = LoggerFactory.getLogger(SimpleMultiThreadedReportRunnerWithProgress.class);
    ...
    public void generate() throws Exception {
        ...
        Observable<String[]> source1Observable = source1.asSingleThreadedObservable().subscribeOn(Schedulers.io());
        Observable<String[]> source2Observable = source2.asSingleThreadedObservable().subscribeOn(Schedulers.io());
        Observable<String[]> source3Observable = source3.asSingleThreadedObservable().subscribeOn(Schedulers.io());
    ...
    public static void main(String[] args) throws Exception {
        new SimpleMultiThreadedReportRunnerWithProgress().generate();
    }
}
