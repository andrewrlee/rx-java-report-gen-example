...
public class SimpleMultiThreadedReportRunner {

    private static final Logger L = LoggerFactory.getLogger(SimpleMultiThreadedReportRunner.class);
    ...
    public static void main(String[] args) throws Exception {
        new SimpleMultiThreadedReportRunner().generate();
    }
}
